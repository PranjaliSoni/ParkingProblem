...
public class user_pge extends JFrame {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/parkingproblem";
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException{
		...
		conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/parkingproblem?","root","");
    ...
    public user_pge() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		...
        		if(validemail&&validphone&&validcar)
        		{
                        ...
                        ticket.main(null);
        		try {
					pst=conn.prepareStatement("select * from pptable where carno=? and phoneno=?");
               ...
               else 
               {
        		try {
					...
					pst=conn.prepareStatement("insert into pptable(carno,phoneno,qrcode,timeslot,parkingslot,pcheck) values(?,?,?,?,?,?)");
					pst.setString(1,carno);
					pst.setString(2,phoneno);
					pst.setString(3,carno+"/"+phoneno);
					pst.setInt(4,(int) current_time);
        ...
        timer=new Timer(6000,new ActionListener(){
        	...
        	public void actionPerformed(ActionEvent e)
        	{
        		...
        		try {
					pst=conn.prepareStatement("select timeslot,qrcode,carno,phoneno,pcheck,parkingslot from pptable");
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
        		...
        		try {
					while(rst.next())
					{
						timeslott=rst.getInt(1);
						qrcodet=rst.getString(2);
							carnot=rst.getString(3);
							phonenot=rst.getString(4);
								pcheckt=rst.getBoolean(5);
						    parkingslott=rst.getString(6);
